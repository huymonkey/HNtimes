...
@section('content')
    <div class="container">
                        ...
                        <div class="widget-payment-request-container">
                            <div class="widget-payment-request-author">
                                <div class="avatar m-r-sm">
                                    <img src="/admin/assets/images/avatars/avatar2.png" alt="">
                                </div>
                            ...
                            <div class="widget-payment-request-product">
                                <div class="widget-payment-request-product-image m-r-sm">
                                    <img src="/admin/assets/images/other/facebook_logo.png" class="mt-auto"
                                        alt="">
                                </div>
                    ...
                    <div class="card-body">
                        <div class="widget-popular-product-container">
                            <div class="widget-popular-product-image">
                                <img src="/admin/assets/images/widgets/popular-product.jpg" alt="">
                            </div>
                            ...
                            <div class="widget-popular-product-content">
                                ...
                                <p class="widget-popular-product-text m-b-md">Quisque congue risus sit amet pellentesque
                                    fermentum. Etiam nibh erat, convallis ac dui nec, imperdiet dignissim nulla. Ut
                                    tincidunt tellus sit amet elit viverra porttitor. Mauris at tellus a nisl accumsan
                                    egestas suscipit..</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="widget-stats-large-info-container">
                                <div class="card-header">
                                    <h5 class="card-title">Report<span class="badge badge-info badge-style-light">Updated
                                            5 min ago</span></h5>
                                </div>
                                <div class="card-body">
        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="card">
                    <img src="/admin/assets/images/widgets/blog5.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="widget-popular-blog-container">
                            <div class="widget-popular-blog-image">
                                <img src="/admin/assets/images/widgets/product2.jpg" alt="">
                            </div>
                        ...
                        <div class="widget-connection-request-container d-flex">
                            <div class="widget-connection-request-avatar">
                                <div class="avatar avatar-xl m-r-xs">
                                    <img src="/admin/assets/images/avatars/avatar8.jpg" alt="">
                                </div>
                            </div>
