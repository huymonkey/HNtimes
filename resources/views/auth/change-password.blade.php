...
<div class="app app-auth-lock-screen align-content-stretch d-flex flex-wrap justify-content-end">
    ...
    <div class="app-auth-container">
        ...
        <p class="auth-description">Please enter your new password</p>
        @if(session()->has('message') && session('message'))
            <div class="auth-credentials m-b-lg mt-2">
                <div class="alert alert-{{ session('message')['type'] }}">{{ session('message')['content'] }}</div>
            </div>
        @endif
        <form action="{{ route('auth.handleChangePassword', $token) }}" method="POST">
            @csrf
            <div class="auth-credentials m-b-md">
                <label for="newPassword" class="form-label">New Password</label>
                <input type="password" class="form-control @error('password') is-invalid @enderror" id="newPassword" aria-describedby="newPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" name="password">
                @if(!$errors->any())
            ...
            <div class="auth-credentials m-b-md">
                ...
                <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" id="confirmNewPassword" aria-describedby="confirmNewPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" name="password_confirmation">
